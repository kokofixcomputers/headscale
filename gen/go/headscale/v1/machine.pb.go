...
type ChangeIPAddressesMachineRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	MachineId      uint64   `protobuf:"varint,1,opt,name=machine_id,json=machineId,proto3" json:"machine_id,omitempty"`
	NewIpAddresses []string `protobuf:"bytes,2,rep,name=new_ip_addresses,json=newIpAddresses,proto3" json:"new_ip_addresses,omitempty"`
}

func (x *ChangeIPAddressesMachineRequest) Reset() {
	*x = ChangeIPAddressesMachineRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChangeIPAddressesMachineRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChangeIPAddressesMachineRequest) ProtoMessage() {}

func (x *ChangeIPAddressesMachineRequest) ProtoReflect() protoreflect.Message {
	mi := &file_headscale_v1_machine_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChangeIPAddressesMachineRequest.ProtoReflect.Descriptor instead.
func (*ChangeIPAddressesMachineRequest) Descriptor() ([]byte, []int) {
	return file_headscale_v1_machine_proto_rawDescGZIP(), []int{13}
}

func (x *ChangeIPAddressesMachineRequest) GetMachineId() uint64 {
	if x != nil {
		return x.MachineId
	}
	return 0
...
func (x *ChangeIPAddressesMachineRequest) GetNewIpAddresses() []string {
	if x != nil {
		return x.NewIpAddresses
	}
	return nil
}

type ChangeIPAddressesMachineResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ChangeIPAddressesMachineResponse) Reset() {
	*x = ChangeIPAddressesMachineResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChangeIPAddressesMachineResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChangeIPAddressesMachineResponse) ProtoMessage() {}

func (x *ChangeIPAddressesMachineResponse) ProtoReflect() protoreflect.Message {
	mi := &file_headscale_v1_machine_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChangeIPAddressesMachineResponse.ProtoReflect.Descriptor instead.
func (*ChangeIPAddressesMachineResponse) Descriptor() ([]byte, []int) {
	return file_headscale_v1_machine_proto_rawDescGZIP(), []int{14}
}

func (x *ChangeIPAddressesMachineResponse) GetMachine() *Machine {
	if x != nil {
		return x.Machine
	}
	return nil
...
func (x *DebugCreateMachineRequest) Reset() {
	*x = DebugCreateMachineRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_headscale_v1_machine_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DebugCreateMachineRequest) Descriptor() ([]byte, []int) {
	return file_headscale_v1_machine_proto_rawDescGZIP(), []int{19}
}
...
func (x *DebugCreateMachineResponse) Reset() {
	*x = DebugCreateMachineResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_headscale_v1_machine_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DebugCreateMachineResponse) Descriptor() ([]byte, []int) {
	return file_headscale_v1_machine_proto_rawDescGZIP(), []int{20}
}
...
var file_headscale_v1_machine_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x72, 0x22, 0x46, 0x0a, 0x13, 0x4d, 0x6f, 0x76, 0x65, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65,
	...
	0x52, 0x07, 0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x22, 0x6d, 0x0a, 0x19, 0x44, 0x65, 0x62,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65,
	...
	0x52, 0x06, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x22, 0x4d, 0x0a, 0x1a, 0x44, 0x65, 0x62, 0x75,
	...
	0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x2a, 0x82, 0x01, 0x0a, 0x0e, 0x52, 0x65, 0x67, 0x69,
	...
	0x45, 0x54, 0x48, 0x4f, 0x44, 0x5f, 0x4f, 0x49, 0x44, 0x43, 0x10, 0x03, 0x42, 0x29, 0x5a, 0x27,
...
var file_headscale_v1_machine_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_headscale_v1_machine_proto_goTypes = []interface{}{
	...
	(*ChangeIPAddressesMachineRequest)(nil),  // 14: headscale.v1.ChangeIPAddressesMachineRequest
	(*ChangeIPAddressesMachineResponse)(nil), // 15: headscale.v1.ChangeIPAddressesMachineResponse
	(*ListMachinesRequest)(nil),              // 16: headscale.v1.ListMachinesRequest
	(*ListMachinesResponse)(nil),             // 17: headscale.v1.ListMachinesResponse
	(*MoveMachineRequest)(nil),               // 18: headscale.v1.MoveMachineRequest
	(*MoveMachineResponse)(nil),              // 19: headscale.v1.MoveMachineResponse
	(*DebugCreateMachineRequest)(nil),        // 20: headscale.v1.DebugCreateMachineRequest
	(*DebugCreateMachineResponse)(nil),       // 21: headscale.v1.DebugCreateMachineResponse
...
var file_headscale_v1_machine_proto_depIdxs = []int32{
	22, // 0: headscale.v1.Machine.user:type_name -> headscale.v1.User
	23, // 1: headscale.v1.Machine.last_seen:type_name -> google.protobuf.Timestamp
	23, // 2: headscale.v1.Machine.last_successful_update:type_name -> google.protobuf.Timestamp
	23, // 3: headscale.v1.Machine.expiry:type_name -> google.protobuf.Timestamp
	24, // 4: headscale.v1.Machine.pre_auth_key:type_name -> headscale.v1.PreAuthKey
	23, // 5: headscale.v1.Machine.created_at:type_name -> google.protobuf.Timestamp
	...
	1,  // 12: headscale.v1.ChangeIPAddressesMachineResponse.machine:type_name -> headscale.v1.Machine
	1,  // 13: headscale.v1.ListMachinesResponse.machines:type_name -> headscale.v1.Machine
	1,  // 14: headscale.v1.MoveMachineResponse.machine:type_name -> headscale.v1.Machine
	1,  // 15: headscale.v1.DebugCreateMachineResponse.machine:type_name -> headscale.v1.Machine
...
func file_headscale_v1_machine_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_headscale_v1_machine_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChangeIPAddressesMachineRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_headscale_v1_machine_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChangeIPAddressesMachineResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_headscale_v1_machine_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_headscale_v1_machine_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
